...
function wpdemo_scripts() {
	wp_enqueue_style( 'wpdemo-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'wpdemo-style', 'rtl', 'replace' );

	wp_enqueue_script( 'wpdemo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
